...
export const getStaticPaths = async () => {
    // get everything where type is product -- 
    // get current property slug of each product
...
// Use if the data required to render the page is available 
// at build time ahead of the users request
